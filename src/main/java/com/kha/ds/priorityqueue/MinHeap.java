...
public class MinHeap {
    ...
    MinHeap(){
        lastIndex =0;
        heapSize=1600;
        heap=new Integer[1600];
    }

    public Integer[] insert(Integer object){
    ...
    public static void main(String[] args) {
        ...
        for(String s : st){
            maxHeap.insert(new Integer(s));
        }
        for(int i= 0;i<st.length;i++){
            Integer top = maxHeap.removeTop();
